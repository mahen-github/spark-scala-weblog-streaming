  ...
  def parseLine(fileStream: DStream[String]): DStream[Line] = {
    ...
    val dataV = fileStream.map { line =>
      ...
      if (matcher.find) {
        ...
        Line(matcher.group(1), matcher.group(2), matcher.group(3), matcher.group(4), matcher.group(5), matcher.group(6), matcher.group(7), matcher.group(8), matcher.group(9), glVal._1, glVal._2, glVal._3, glVal._4, glVal._5)
      } else Line("", "", "", "", "", "", "", "", "", "", "", 0, "", "")
    }
    dataV
  }
